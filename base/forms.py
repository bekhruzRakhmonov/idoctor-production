...
class UserLoginForm(forms.Form):
	...
	password = forms.CharField(label='Password',widget=forms.PasswordInput(attrs={'autocomplete': 'on'}))
...
class ChangeUserForm(forms.Form):
    name = forms.CharField(label="New Name",widget=forms.TextInput(attrs={'placeholder':'Enter a new name'}))
    email = forms.EmailField(label="New email",widget=forms.EmailInput(attrs={'placeholder':'Enter a new email...'}),required=False)
